...
/* ./.libs/lt-getdns_query.c - temporary wrapper executable for .libs/getdns_query
   Generated by libtool (GNU libtool) 2.4

   The getdns_query program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\home\\gvisweswaran\\getdns-0.3.3\\getdns\\src;C:\\MinGW\\msys\\1.0\\local\\ssl\\lib;C:\\MinGW\\msys\\1.0\\local\\ssl\\bin;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "getdns_query"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# getdns_query - temporary wrapper script for .libs/getdns_query\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The getdns_query program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"getdns_query:getdns_query:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"getdns_query:getdns_query:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"getdns_query:getdns_query:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/home/gvisweswaran/getdns-0.3.3/getdns/src:/usr/local/ssl/lib:/usr/local/ssl/bin:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
